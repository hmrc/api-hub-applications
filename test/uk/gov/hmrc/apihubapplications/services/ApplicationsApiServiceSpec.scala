...
import uk.gov.hmrc.apihubapplications.models.application.{Api, Application, Creator, Credential, Endpoint, Environment, Environments, Secondary, TeamMember}
...
class ApplicationsApiServiceSpec extends AsyncFreeSpec with Matchers with MockitoSugar with ArgumentMatchersSugar with OptionValues with EitherValues {
  ...
  private def buildFixture(): Fixture = {
    ...
    val service = new ApplicationsApiServiceImpl(searchService, accessRequestsService, idmsConnector, repository, scopeFixer, clock)
    Fixture(searchService, accessRequestsService, idmsConnector, repository, scopeFixer, service)
  }
