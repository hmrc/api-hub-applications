...
object DeploymentsServiceSpec {
  ...
  val deploymentsRequest: DeploymentsRequest = DeploymentsRequest("test-line-of-business", "test-name", "test-description", "test-egress", "test-team-id", "test-oas", false, "a status", Some("a domain"), Some("a subdomain"))
