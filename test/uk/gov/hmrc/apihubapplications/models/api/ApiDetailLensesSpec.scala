...
import uk.gov.hmrc.apihubapplications.models.application.{Api, Application, Creator, Endpoint as ApplicationEndpoint}
...
object ApiDetailLensesSpec {
  ...
  def baseApiDetail(id: String): ApiDetail = ApiDetail(id, "test-publisher-ref", "test-title", "test-description", "test-version", Seq.empty, None, "test-oas", Live, None, None, None, Seq.empty, Instant.now, "platform", Maintainer("test-name", "test-slack", List.empty), None)
