...
import com.github.tomakehurst.wiremock.client.WireMock.{aResponse, equalTo, equalToJson, get, getRequestedFor, post, postRequestedFor, urlMatching}
...
import uk.gov.hmrc.apihubapplications.config.InternalAuthTokenInitialiser
