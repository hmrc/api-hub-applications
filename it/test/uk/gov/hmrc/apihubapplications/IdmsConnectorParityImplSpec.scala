...
import uk.gov.hmrc.apihubapplications.connectors.{IdmsConnector, IdmsConnectorParityImpl}
...
class IdmsConnectorParityImplSpec
  ...
  import IdmsConnectorParityImplSpec.*
...
object IdmsConnectorParityImplSpec extends HttpClientV2Support with TableDrivenPropertyChecks {
  ...
  def buildConnector(wireMockSupport: WireMockSupport)(implicit ec: ExecutionContext): IdmsConnector = {
    ...
    new IdmsConnectorParityImpl(httpClientV2, hipEnvironments)
  }
