...
import uk.gov.hmrc.apihubapplications.connectors.{APIMConnector, APIMConnectorParityImpl}
...
class APIMConnectorParityImplSpec
  ...
  import APIMConnectorParityImplSpec.*
...
object APIMConnectorParityImplSpec extends HttpClientV2Support {
  ...
  private def buildConnector(wireMockSupport: WireMockSupport)(implicit ec: ExecutionContext): APIMConnector = {
    ...
    new APIMConnectorParityImpl(httpClientV2, hipEnvironments)
  }
