...
package uk.gov.hmrc.apihubapplications.models.deployments
...
// Only needed in the FE. Return this from the connector method.
case class DeploymentStatuses(statuses: Seq[DeploymentStatus]) {

  def forEnvironment(environmentName: EnvironmentName): DeploymentStatus = {
