...
import uk.gov.hmrc.apihubapplications.models.api.{ApiDetail, ApiDetailWithoutOAS, ApiTeam}
...
trait IntegrationCatalogueConnector {
  ...
  def findApis(queryParams: Seq[(String,String)])(implicit hc: HeaderCarrier): Future[Either[ApplicationsException, Seq[ApiDetailWithoutOAS]]]

  def findApis(platformFilter: String)(implicit hc: HeaderCarrier): Future[Either[ApplicationsException, Seq[ApiDetailWithoutOAS]]] = {
    findApis(Seq(("platformFilter", platformFilter)))
  }

  def findHipApis()(implicit hc: HeaderCarrier): Future[Either[ApplicationsException, Seq[ApiDetailWithoutOAS]]] = {
    findApis("HIP")
  }
